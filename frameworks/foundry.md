...
Foundry is the framework I run every idea through before I decide whether it's worth building. It's the layer between "I have an idea" and "I'm opening an editor" — the thing that decides what should get built before anyone decides how.
